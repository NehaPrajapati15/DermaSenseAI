...
class SkinLesionModel(nn.Module):
    def __init__(self, num_classes=7):
        ...
        self.base_model.fc = nn.Linear(self.base_model.fc.in_features, 7)
...
state_dict = torch.load("best_skin_cancer_model.pth", map_location=device)

# 🔥 Add prefix to match your model
new_state_dict = {}
...
def process_image(image_path):
    ...
    valid,msg=validate_input_image(image_path)
    ...
    if confidence_value <50:
        raise Exception(
            "Invalid lesion image. Re-upload."
        )
